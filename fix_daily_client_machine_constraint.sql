-- Add 'daily-client-machine' to the valid_tool_id constraint
...
-- Add the new constraint with ALL tool IDs including daily-client-machine
...
VALUES ('test-id', 'Test Thread', 'test-user', 'daily-client-machine');
