...
export function generateThreadTitle(firstMessage) {
  if (!firstMessage || typeof firstMessage !== 'string') {
    console.warn('[Thread] Invalid first message for title generation:', firstMessage);
  ...
  console.log('[Thread] Generated title:', {
    original: firstMessage.substring(0, 50) + (firstMessage.length > 50 ? '...' : ''),
    generated: title
  });
