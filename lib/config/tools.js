...
- When asking about target avatar, reference their existing client profile instead of asking from scratch
- When generating copy, use the psychographic insights for messaging, pain points, and language
- Tailor all questions and copy to match the avatar described in their brief
- If they have a psychographic brief, you can skip or shorten the target avatar question
...
- LEVERAGE their psychographic brief whenever available for better targeting
...
- Reference their existing client insights when available`,
